"""
Django settings for htk_farms project.
...
SECRET_KEY = 'django-insecure-18njs_v@+i=0!nl6g)11dp=^n=8%o^&b1uof3c&3ehu6m537y('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'htkapp.context_processors.categories_processor',
                'htkapp.views.get_cart_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'htk_farms.wsgi.application'
